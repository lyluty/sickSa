...
DROP SEQUENCE INCT_ID_SEQ;

CREATE SEQUENCE INCT_ID_SEQ NOMAXVALUE NOCACHE NOORDER NOCYCLE;
...
DROP SEQUENCE ING_ID_SEQ;

CREATE SEQUENCE ING_ID_SEQ NOMAXVALUE NOCACHE NOORDER NOCYCLE;
