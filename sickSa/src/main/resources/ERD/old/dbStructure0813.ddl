...
DROP TABLE QUEUE_STATE_DATA CASCADE CONSTRAINTS;
...
/* Table Name: 대기상태 */
/**********************************/
CREATE TABLE QUEUE_STATE_DATA(
		QSTD_ID                       		NUMBER(2)		 NULL ,
		QSTD_NAME                     		VARCHAR2(10)		 NOT NULL
);

COMMENT ON TABLE QUEUE_STATE_DATA is '대기상태';
COMMENT ON COLUMN QUEUE_STATE_DATA.QSTD_ID is '대기상태ID';
COMMENT ON COLUMN QUEUE_STATE_DATA.QSTD_NAME is '대기상태이름';
...
COMMENT ON COLUMN QUEUE_LOGS.QSTD_ID is '대기상태ID';
...
ALTER TABLE QUEUE_STATE_DATA ADD CONSTRAINT IDX_QUEUE_STATE_DATA_PK PRIMARY KEY (QSTD_ID);

ALTER TABLE QUEUE_LOGS ADD CONSTRAINT IDX_QUEUE_LOGS_PK PRIMARY KEY (QLOG_ID);
ALTER TABLE QUEUE_LOGS ADD CONSTRAINT IDX_QUEUE_LOGS_FK0 FOREIGN KEY (QSTD_ID) REFERENCES QUEUE_STATE_DATA (QSTD_ID);
