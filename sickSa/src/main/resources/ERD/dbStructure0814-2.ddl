...
DROP TABLE QUEUE_LOG_STATES CASCADE CONSTRAINTS;
...
CREATE TRIGGER TABLES_TBL_ID_TRG
BEFORE INSERT ON TABLES
FOR EACH ROW
BEGIN
IF :NEW.TBL_ID IS NOT NULL THEN
  SELECT TABLES_TBL_ID_SEQ.NEXTVAL INTO :NEW.TBL_ID FROM DUAL;
END IF;
END;
...
CREATE TRIGGER INGREDIENTS_ING_ID_TRG
BEFORE INSERT ON INGREDIENTS
FOR EACH ROW
BEGIN
IF :NEW.ING_ID IS NOT NULL THEN
  SELECT INGREDIENTS_ING_ID_SEQ.NEXTVAL INTO :NEW.ING_ID FROM DUAL;
END IF;
END;
...
DROP SEQUENCE INGREDIENT_CATEGORIES_IGCT_ID_SEQ;

CREATE SEQUENCE INGREDIENT_CATEGORIES_IGCT_ID_SEQ NOMAXVALUE NOCACHE NOORDER NOCYCLE;

CREATE TRIGGER INGREDIENT_CATEGORIES_IGCT_ID_TRG
BEFORE INSERT ON INGREDIENT_CATEGORIES
FOR EACH ROW
BEGIN
IF :NEW.IGCT_ID IS NOT NULL THEN
  SELECT INGREDIENT_CATEGORIES_IGCT_ID_SEQ.NEXTVAL INTO :NEW.IGCT_ID FROM DUAL;
END IF;
END;
...
CREATE TRIGGER INGREDIENT_DETAILS_ING_ID_TRG
BEFORE INSERT ON INGREDIENT_DETAILS
FOR EACH ROW
BEGIN
IF :NEW.ING_ID IS NOT NULL THEN
  SELECT INGREDIENT_DETAILS_ING_ID_SEQ.NEXTVAL INTO :NEW.ING_ID FROM DUAL;
END IF;
END;
...
DROP SEQUENCE QUEUE_LOGS_QLOG_ID_SEQ;

CREATE SEQUENCE QUEUE_LOGS_QLOG_ID_SEQ NOMAXVALUE NOCACHE NOORDER NOCYCLE;

CREATE TRIGGER QUEUE_LOGS_QLOG_ID_TRG
BEFORE INSERT ON QUEUE_LOGS
FOR EACH ROW
BEGIN
IF :NEW.QLOG_ID IS NOT NULL THEN
  SELECT QUEUE_LOGS_QLOG_ID_SEQ.NEXTVAL INTO :NEW.QLOG_ID FROM DUAL;
END IF;
END;
