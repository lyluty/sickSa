...
<div id="mainCarousel" class="carousel slide" data-ride="carousel" style="width:70%; margin:auto;"> 
	...
	<div class="carousel-inner">
		...
		<div class="item active"> 
			<a href="http://www.gyudong.com/4020" >
			<img src="include/images/main_visual_01.png" style="width:100%" data-src="" alt="First slide"></a>
			<div class="container">
		...
		<!--슬라이드2-->
		<div class="item"> 
			<a href="http://www.gyudong.com/4010">
			<img src="include/images/main_visual_02.png"   style="width:100%" data-src="" alt="Second slide"></a>
			<div class="container">
				<div class="carousel-caption">
					<p>디자이너 휴가갔나봄..</p>
				</div>
		...
		<!--슬라이드3-->
		<div class="item"> 
		<a href="http://www.gyudong.com/4040">
			<img src="include/images/main_visual_03.png"   style="width:100%" data-src="" alt="Third slide"></a>
			<div class="container">
			</div>
		</div>
		<!--슬라이드3-->
	...
	<!-- Content Holder Start -->
          <div class="content-holder">
			...
			<button class="btn btn-default"
				style="display: block; margin: 0 auto;" onclick="상품리스트">to Order
			</button>
     </div>
