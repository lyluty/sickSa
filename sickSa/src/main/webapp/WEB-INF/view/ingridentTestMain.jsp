...
<script type="text/javascript">
	...
	function loadListById() {
		...
		var p1 = document.getElementById("loadCategoriesListById");
		var list = p1.getAttribute("${ingredient.igct_name}");
		alert(list);
	}
	
	document.loadB.onClick()= function(){
		loadListById();
	}
</script>
	...
	<div class="animsition">
		...
		<nav id="ml-menu" class="menu">
			...
			<div class="menu__wrap">
				<ul data-menu="main" class="menu__level" id="loadCategoriesListById">
					<c:forEach var="ingredient" items="${ingredientCategoriesList}">
						<li class="menu__item">
						<a class="menu__link menu__link--current" data-submenu="submenu-1" href="#"> ${ingredient.igct_name}</a></li>
					</c:forEach>
				</ul>
				<!-- Submenu 1 -->
			...
			<div class="hero-image hero-slider1">
				...
				<div class="hero-image-slides">
					<div class="hero-image-content">
						...
						<input id="loadB" type="button" value="되냐?" onclick="loadListById()" />
						<h6>
