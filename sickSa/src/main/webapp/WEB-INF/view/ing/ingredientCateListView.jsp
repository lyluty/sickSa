			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="igctForm">
						...
						<div class="form-group">
							<label for="igct_name" class="form-control-label">항목 명:</label> <input type="text" class="form-control" id="igct_name"
								name="igct_name"
							/>
						</div>
						<!-- <div class="form-group">
					...
					<div class="row">
						<div class="col-sm-7">
							<form id="ingForm">
								...
								<div class="form-group">
									<label for="ing_name" class="form-control-label">재료 명:</label> <input type="text" class="form-control" name="ing_name">
								</div>
								<div class="form-group">
									<label for="ing_stock" class="form-control-label">재고:</label> <input type="text" class="form-control" name="ing_stock">
								</div>
								<div class="form-group">
									<label for="ing_measure" class="form-control-label">재료 단위:</label> <input type="text" class="form-control" name="ing_measure">
								</div>
								<div class="form-group">
									<label for="igdt_price" class="form-control-label">단가:</label> <input type="text" class="form-control" name="igdt_price">
								</div>
								<div class="form-group">
									<label for="igdt_contact" class="form-control-label">거래처 번호:</label> <input type="text" class="form-control" name="igdt_contact">
								</div>
							</form>
						</div>
					</div>
